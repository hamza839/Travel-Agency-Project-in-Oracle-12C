...
public class Admin_agent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        show_agent = new javax.swing.JButton();
        ...
        show_agent.setBackground(new java.awt.Color(255, 255, 255));
        show_agent.setFont(new java.awt.Font("Rockwell Extra Bold", 0, 18)); // NOI18N
        show_agent.setText("Show Agent");
        show_agent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                show_agentActionPerformed(evt);
            }
        });
        panel1.add(show_agent);
        show_agent.setBounds(340, 210, 180, 40);
    ...
    private void show_agentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_show_agentActionPerformed
        // TODO add your handling code here:"
        show_agent agent = new show_agent();
        dispose();
        agent.show();
    }//GEN-LAST:event_show_agentActionPerformed
    ...
    private javax.swing.JButton show_agent;
