...
public class Agent_customer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        show_cust.setFont(new java.awt.Font("Rockwell Extra Bold", 0, 14)); // NOI18N
        show_cust.setText("Show Customer");
        show_cust.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                show_custActionPerformed(evt);
            }
        });
        jPanel1.add(show_cust);
        show_cust.setBounds(240, 170, 190, 50);
        ...
        update_cust.setBounds(450, 170, 190, 50);
    ...
    private void show_custActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_show_custActionPerformed
        // TODO add your handling code here:
         showcust_agent cust = new showcust_agent();
         dispose();
         cust.show();
