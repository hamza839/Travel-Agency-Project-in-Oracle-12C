...
public class User_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        auser = new javax.swing.JComboBox<>();
    ...
    private void signInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signInActionPerformed
        ...
        try{
            //String sql = "select * from main where uname=? and pass=?";
                ...
                else if(auser.getSelectedIndex()==1)
                {
                ...
                else if(auser.getSelectedIndex()==2)
                {
                    String sql = "select * from customer where cust_CNIC=? and cust_name=?";
                    pst = (OraclePreparedStatement) conn.prepareStatement(sql);
                    pst.setString(1, user.getText());
                    pst.setString(2, pass.getText());
                    //pst.setString(3, String.valueOf(jComboBox1.getSelectedItem()));
